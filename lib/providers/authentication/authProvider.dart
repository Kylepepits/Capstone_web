...
class UserDetailsProvider with ChangeNotifier {
  ...
  Future<void> fetchUserDetails() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Provide a more specific error message based on the response status code
        final errorMessage =
      ...
      final errorMessage = 'Error occurred while fetching user details: $error';
      print(errorMessage);
      throw Exception(errorMessage);
    }
  }
  ...
  Future<void> updateDetails({
    ...
    final response = await http.put(
      Uri.parse(
          'http://127.0.0.1:8000/update_user/'), // Replace with your endpoint
      headers: {
        'Content-Type': 'application/json; charset=UTF-8',
